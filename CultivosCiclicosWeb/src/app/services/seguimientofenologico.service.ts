...
import { Seguimientofenologico } from 'src/app/usuarios/interfaces/seguimientofenologico.interface';
...
export class SeguimientofenologicoService {
  ...
  getListadoSeguimientos(usuario: number, areaMuestra_id : number, variedad_id: number): Observable<Seguimientofenologico[]>
  {
    ...
    return this.http.get<Seguimientofenologico[]>(this.urlGetSiembra, { headers: this.headers, params: queryParams });
  }
